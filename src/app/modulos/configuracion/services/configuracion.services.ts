...
export class ConfiguracionService {
  ...
  public getDatos() {
    ...
    return this.api.getHttp<Configuracion[]>(url);
  }

  public setDatos(configuracion: Configuracion){
    const url = `${this.seccion}/actualizar`;
    idUserModificacionToObject(configuracion);

    return this.api.putHttp<Ejecucion>(url, configuracion);
  }
